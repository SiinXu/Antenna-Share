...
<template>
  <div class="min-h-full flex flex-col">
    ...
    <!-- 内容区域 -->
    <div class="flex-1 relative flex flex-col bg-[#8B0000] text-[#FFD700] space-y-6">
      <!-- 头像区域 -->
      <div class="relative -mt-12">
        <div class="relative">
          <div class="absolute -inset-1 bg-gradient-to-r from-yellow-400 via-red-300 to-yellow-400 rounded-full blur opacity-75"></div>
      ...
      <!-- 自定义链接 -->
      <div v-if="acc.ls?.length" class="px-6 space-y-4">
      ...
      <div class="mt-auto pt-16 px-6 pb-8 text-center">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          class="text-sm text-yellow-200/70 hover:opacity-80"
        >
          Made with Antenna
        </a>
      </div>
